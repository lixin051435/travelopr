...
function uploadimg()
{ 
pop("/travelopr/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/travelopr/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/travelopr/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/travelopr/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/travelopr/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/travelopr/js/uploaddoc.jsp","上传文档",300,77)
}

function uploaddoc2()
{
pop("/travelopr/js/uploaddoc2.jsp","上传文档",300,77)
}

function uploaddoc3()
{
pop("/travelopr/js/uploaddoc3.jsp","上传文档",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/travelopr/js/dialogclose.gif  />';
   var cB='filter: alpha(opacity='+this.info.coverOpacity+');opacity:'+this.info.coverOpacity/100+';';
   var cover='<div id="dialogBoxBG" style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:'+baseZIndex+';'+cB+'background-color:;display:none;border:0px"></div>';
   var mainBox='<div id="dialogBox" style="border:1px solid '+this.color.tColor+';display:none;z-index:'+showZIndex+';position:relative;width:'+this.config.width+'px;background-color:white;"><table width="100%" border="0" cellpadding="0" cellspacing="0" >';if(this.config.isHaveTitle){mainBox+='<tr height="24" bgcolor="'+this.color.tColor+'"><td><table style="-moz-user-select:none;height:24px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr>'+'<td width="6" height="24" style="border:0px"></td><td id="dialogBoxTitle" style="color:'+this.color.wColor+';font-size:14px;font-weight:bold;border:0px">'+this.info.title+'&nbsp;</td>'+'<td id="dialogClose" style="border:0px" width="20" align="right" valign="middle">'+close+'</td><td width="6" style="border:0px"></td></tr></table></td></tr>'}
   ...
   if(this.config.isSupportDraging){dropClass=new Dragdrop(this.config.width,this.config.height,this.info.shadowWidth,this.config.isSupportDraging,this.config.contentType);G("dialogBoxTitle").style.cursor="move"};this.lastBuild()},lastBuild:function(){var confirm='<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;border:0px">'+this.info.confirmCon+'</div><div style="margin:20px;"><input id="dialogOk" type="button" value=" 确定 "/>&nbsp;<input id="dialogCancel" type="button" value=" 取消 "/></div></div>';
   var alert='<div style="width:100%;height:100%;text-align:center;border:0px"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'+this.info.alertCon+'</div><div style="margin:20px;"><input id="dialogYES" type="button" value=" 确定 "/></div></div>';
   ...
   var coverIframe="<div id='iframeBG' style='position:absolute;top:0px;left:0px;width:1px;height:1px;z-index:"+coverIfZIndex+";filter: alpha(opacity=00);opacity:0.00;background-color:#ffffff;border:0px'><div>";G("dialogBody").innerHTML=openIframe+coverIframe}
