...
<!-- servletformstart 
<form  action="/travelopr/travelopr?ac=articlexg&id=<%=mmm.get("id")%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/travelopr/travelopr/articlexg.do?id=<%=mmm.get("id")%>" > 
  <!-- s2formend -->
<center>
