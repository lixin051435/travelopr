...
<form name="f1" autocomplete="off"  action="hysysusercx.jsp"  method="post" style="display: inline;font-size: 14px">
<center>
...
<input type=submit class='' value='查询信息' />
 &nbsp;
<!--   <jsp:include page='/travelopr/hysysusercx.do'>
<jsp:param name="uname" value="<%=puname %>" /> 
<jsp:param name="utype" value="<%=putype %>" /> 
...
HashMap<String,String> selectbmap = new HashMap();
 ...
 selectmap.put("utype","");  
 selectmap.put("tname","");  
 selectymap.put("utype","用户");  
String sql = Info.selectBuild3("sysuser",selectmap,selectymap,selectbmap,request) ;
String url = "hysysusercx.jsp?1=1&uname="+puname+"&utype="+putype+"&tname="+ptname+""; 
...
<a href="hysysusercx.jsp?value=锁定&statusid1=<%=map.get("id")%>">锁定</a>
&nbsp;&nbsp;|&nbsp;&nbsp;
<a href="hysysusercx.jsp?value=正常&statusid2=<%=map.get("id")%>">解锁</a>
&nbsp;&nbsp;|&nbsp;&nbsp;
...
<tr>
<td colspan=12 height="35" align="center">${page.info}</td>
</tr>
