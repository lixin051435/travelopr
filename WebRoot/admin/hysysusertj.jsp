...
<!-- servletformstart 
<form  action="/travelopr/travelopr?ac=hysysusertj&tglparentid=<%=tglparentid%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()" action="/travelopr/travelopr/hysysusertj.do?tglparentid=<%=tglparentid%>" > 
  <!-- s2formend -->
<center>
