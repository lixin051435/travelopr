...
<form name="f1" autocomplete="off"  action="gmixinfocx.jsp"  method="post" style="display: inline;font-size: 14px">
<center>
...
<td align="center" height=33>相关图片  </td>
...
<tr ng-repeat="x in names">
    ...
    <td align="center" height=33><img src="/travelopr/upfile/<%=map.get("filename")%>" height=75 width="240" /></td>
    <td align="center" height=33>
<a href="gmixinfoxg.jsp?id=<%=map.get("id")%>">修改</a> 
</td>
</tr>
<%}%> 
