...
<!-- servletformstart 
<form  action="/travelopr/travelopr?ac=prosxg&id=<%=mmm.get("id")%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/travelopr/travelopr/prosxg.do?id=<%=mmm.get("id")%>" > 
  <!-- s2formend -->
<center>
...
<td width="79%" align="left"  style="padding-left: 5px"><textarea  cols='45' rows='3'  onblur='checkform()'   style='margin-top: 1px;margin-bottom: 1px'  class=''   name='remo'   ></textarea></td>
</tr>
<tr ng-repeat="x in names">
