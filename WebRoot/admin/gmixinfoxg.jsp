...
<!-- servletformstart 
<form  action="/travelopr/travelopr?ac=gmixinfoxg&id=<%=mmm.get("id")%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
  servletformend -->
  <!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/travelopr/travelopr/gmixinfoxg.do?id=<%=mmm.get("id")%>" > 
  <!-- s2formend -->
<center>
...
<td width="79%" align="left"  style="padding-left: 5px"><input type=text  onblur='checkform()'  class='' id='mtitle' name='mtitle' size=60 /><label  style='display:inline'  id='clabelmtitle' /></td>
</tr>
<tr ng-repeat="x in names">
<td width="21%" height="32" align="center">链接地址</td>
<td width="79%" align="left"  style="padding-left: 5px"><input type=text  onblur='checkform()'  class='' id='remo' name='remo' size=60 /><label  style='display:inline'  id='clabelremo' /></td>
</tr>
<tr ng-repeat="x in names">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                      
<input type=button value='返回上页' onclick='window.location.replace("gmixinfocx.jsp")' />                               
</td> 
</tr>
